...
Ptr<NrInterference>
NrSpectrumPhy::GetNrInterferenceCtrl() const
{
    NS_LOG_FUNCTION(this);
    return m_interferenceCtrl;
}

Ptr<NrSlInterference>
NrSpectrumPhy::GetSlInterference() const
{
    NS_LOG_FUNCTION(this);
    return m_slInterference;
}
...
{
    // NS_LOG_UNCOND("NrSpectrumPhy::EndRxCtrl");
    NS_LOG_FUNCTION(this);
...
{
    // NS_LOG_UNCOND("NrSpectrumPhy::StartRxSlFrame");
    NS_LOG_FUNCTION(this << " state: " << m_state);
...
NrSpectrumPhy::RxSlPssch(std::vector<uint32_t> paramIndexes)
{
    ...
    // NS_LOG_UNCOND("NrSpectrumPhy::RxSlPssch");
    Ptr<NrUeNetDevice> ueRx = DynamicCast<NrUeNetDevice>(GetDevice());
