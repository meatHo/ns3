...
main(void)
{
    ...
    rsuNodeContainer.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(294.0, 4350.0, 60.0));
    ...
    ueNodeContainer.Get(0)->GetObject<MobilityModel>()->SetPosition(Vector(299.89, 4699.03, 59));
